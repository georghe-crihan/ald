 ...
 */
#define INSIDE_FILE_MACHO(ptr, size, addr)                              \
(                                                                     \
...
struct machoWorkspace *initMACHO();
void termMACHO(struct machoWorkspace *ws);
int checkMACHO(struct machoWorkspace *ws, void *ptr, size_t size,
             struct machoParameters *params, char *str, int platformEndian);
unsigned long loadSymbolsMACHO(struct machoWorkspace *ws);
void unloadSymbolsMACHO(struct machoWorkspace *ws);
int findSectionMACHO(struct machoWorkspace *ws, char *name,
                   unsigned int address, struct machoSectionInfo *secinfo);
int findSymbolMACHO(struct machoWorkspace *ws, char *name,
                  unsigned int address, struct machoSymbolInfo *syminfo);
void printHeaderMACHO(struct machoWorkspace *ws,
                    void (*callback)(void *, const char *, ...), void *args);
void printSectionInfoMACHO(struct machoWorkspace *ws, char *sname,
                         void (*callback)(void *, const char *, ...),
                         void *args);
void printSymbolsMACHO(struct machoWorkspace *ws, char *symname,
                     void (*callback)(void *, const char *, ...),
                     void *args);

#endif /* INCLUDED_libOFF_fmt_macho_h */
